...
CREATE TABLE IF NOT EXISTS `album` (
  ...
  KEY `FK_album_created_by` (`created_by`),
  CONSTRAINT `FK_39986E43B7970CF8` FOREIGN KEY (`artist_id`) REFERENCES `artist` (`id`),
  CONSTRAINT `FK_album_created_by` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Listage des données de la table music_library.album : ~9 rows (environ)
DELETE FROM `album`;
INSERT INTO `album` (`id`, `title`, `date`, `artist_id`, `image`, `created_by`) VALUES
	(2, 'The Eminem Show', '2002-05-26', 2, 'eminem_show.jpg', NULL),
	(3, 'Pyramide', '2024-02-16', 4, 'pyramide_werenoi.jpg', NULL),
	(4, 'Utopia', '2023-07-28', 5, 'utopia_ts.jpg', NULL),
	(5, 'Starboy', '2016-11-25', 3, 'starboy_tk.jpg', NULL),
	(6, 'Loud', '2010-11-12', 6, 'loud_rihanna.jpg', 20),
	(7, 'Heroes & Villains', '2022-12-02', 7, 'hero.jpg', NULL),
	(8, '8 Mile Soundtrack', '2002-10-29', 2, '8-mile.jpg', NULL),
	(9, 'Thriller', '1982-11-29', 8, 'thriller.jpg', 20),
	(10, 'Unapologetic', '2012-11-19', 6, 'unapolo.jpg', NULL);
...
CREATE TABLE IF NOT EXISTS `artist` (
  ...
  `created_by` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_artist_created_by` (`created_by`),
  CONSTRAINT `FK_artist_created_by` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Listage des données de la table music_library.artist : ~7 rows (environ)
DELETE FROM `artist`;
INSERT INTO `artist` (`id`, `name`, `style`, `first_name`, `last_name`, `birth_date`, `nationality`, `image`, `created_by`) VALUES
	(2, 'Eminem', 'hip-hop', 'Marshall', 'Mathers', '1972-10-17', 'Américain', 'eminem.jpg', NULL),
	(3, 'The Weeknd', 'R&B', 'Abel', 'Tesfaye', '1990-02-16', 'Canadien', 'theweeknd.jpg', NULL),
	(4, 'Werenoi', 'Rap', 'Jeremy', 'Bana-Owona', '1994-01-30', 'Francais', 'werenoi.jpg', NULL),
	(5, 'Travis Scott', 'hip-hop', 'Jacques', 'Webster', '1991-04-30', 'Américain', 'travis.jpg', NULL),
	(6, 'Rihanna', 'R&B', 'Robyn', 'Fenty', '1988-02-20', 'barbadienne', 'rihanna.jpg', NULL),
	(7, 'Metro Boomin', 'hip-hop', 'Leland', 'Wayne', '1993-09-16', 'Américain', 'metro.jpg', NULL),
	(8, 'Michael Jackson', 'soul', 'Michael', 'Jackson', '1958-08-29', 'Américain', 'Michael_Jackson.jpg', NULL);
...
-- Listage des données de la table music_library.favoris : ~7 rows (environ)
DELETE FROM `favoris`;
INSERT INTO `favoris` (`id`, `user_id`, `album_id`, `artist_id`, `song_id`) VALUES
	(1, 19, 2, NULL, NULL),
	(3, 20, NULL, NULL, 4),
	(8, 20, NULL, NULL, 9),
	(16, 20, NULL, NULL, 13),
...
CREATE TABLE IF NOT EXISTS `song` (
  ...
  KEY `FK_song_created_by` (`created_by`),
  CONSTRAINT `FK_33EDEEA11137ABCF` FOREIGN KEY (`album_id`) REFERENCES `album` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_song_created_by` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Listage des données de la table music_library.song : ~22 rows (environ)
DELETE FROM `song`;
INSERT INTO `song` (`id`, `title`, `length`, `album_id`, `date`, `file_url`, `image`, `lyrics`, `created_by`) VALUES
	...
	(3, 'THANK GOD', 184, 4, '2023-07-28', 'thank.mp3', 'utopia_ts.jpg', NULL, NULL),
	(4, 'MY EYES', 248, 4, '2023-07-28', 'myeyes.mp3', 'utopia_ts.jpg', NULL, NULL),
	(5, 'FE!N', 188, 4, '2023-07-28', 'fein.mp3', 'utopia_ts.jpg', NULL, NULL),
	(6, 'I KNOW ?', 208, 4, '2023-07-28', 'iknow.mp3', 'utopia_ts.jpg', NULL, NULL),
	(7, 'MELTDOWN', 245, 4, '2023-07-28', 'melt.mp3', 'utopia_ts.jpg', NULL, NULL),
	(8, 'TELEKINESIS', 334, 4, '2023-07-28', 'tele.mp3', 'utopia_ts.jpg', NULL, NULL),
	(9, 'Raindrops (Insane)', 185, 7, '2022-12-03', 'raindrops.mp3', 'hero.jpg', NULL, 20),
	(10, 'Too Many Nights', 194, 7, '2022-12-03', 'toomany.mp3', 'hero.jpg', NULL, NULL),
	(11, 'Trance', 189, 7, '2022-12-03', 'trance.mp3', 'hero.jpg', NULL, NULL),
	(12, 'Creepin’', 205, 7, '2022-12-03', 'creepin.mp3', 'hero.jpg', NULL, NULL),
	(13, 'Die for You', 253, 5, '2016-11-25', 'die_tk.mp4', 'die_tk.png', NULL, NULL),
	(14, 'Lose Yourself', 314, 8, '2002-10-28', 'eminem_lose.mp3', 'lose.jpg', NULL, NULL),
	(15, 'Sing for the Moment', 324, 2, '2003-02-25', 'eminem_sing.mp3', 'eminem_show.jpg', NULL, NULL),
	(16, 'Superman', 268, 2, '2003-01-27', 'eminem-superman.mp3', 'super_eminem.jpg', NULL, NULL),
	(17, 'I Feel It Coming', 275, 5, '2016-11-18', 'ifeel_tk.mp3', 'feel_tk.jpg', NULL, NULL),
	(18, 'Thriller', 334, 6, '1983-11-02', 'michael_thriller.mp3', 'thriller.jpg', NULL, NULL),
	(19, 'Party Monster', 246, 5, '2016-11-18', 'party_tk.mp3', 'party_tk.jpg', NULL, NULL),
	(20, 'Reminder', 211, 5, '2016-11-25', 'remind_tk.mp3', 'reminder_tk.jpg', NULL, NULL),
	(21, 'Rihanna: What\'s My Name?', 255, 6, '2010-10-26', 'rihanna_whats.mp3', 'rihanna_what.png', NULL, NULL),
	(22, 'Starboy', 211, 5, '2016-11-25', 'starboy.mp4', 'starboy_tk.jpg', NULL, NULL),
	(23, 'Diamonds', 308, 10, '2012-11-09', 'diamond.mp3', 'diamond.jpg', NULL, NULL);
...
INSERT INTO `user` (`id`, `username`, `email`, `password`, `profile_picture`, `roles`) VALUES
	...
	(20, 'Alexan', 'alex5@gmail.com', '$2y$13$PaGO6PuO7w/AP8MRE65FD.2NZUJN5.vZfrLJcONV8p0.GAmJTglYW', NULL, '[]');
